...
int NET_LIN5__neoVI_3G_ = 23;
void NET_LIN5__neoVI_3G__ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_LIN5__neoVI_3G_,0);
}
void NET_LIN5__neoVI_3G__GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_LIN5__neoVI_3G_,p_NetworkStats);
}
...
int NET_Ethernet_DAQ__neoVI_3G_ = 71;
void NET_Ethernet_DAQ__neoVI_3G__ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_Ethernet_DAQ__neoVI_3G_,0);
}
void NET_Ethernet_DAQ__neoVI_3G__GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_Ethernet_DAQ__neoVI_3G_,p_NetworkStats);
}
int NET_Ethernet = 72;
...
int NET_SW_CAN2__neoVI_3G_ = 78;
void NET_SW_CAN2__neoVI_3G__ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_SW_CAN2__neoVI_3G_,0);
}
void NET_SW_CAN2__neoVI_3G__GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_SW_CAN2__neoVI_3G_,p_NetworkStats);
}
...
int NET_OP__BR__ETH1 = 87;
void NET_OP__BR__ETH1_ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_OP__BR__ETH1,0);
}
void NET_OP__BR__ETH1_GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_OP__BR__ETH1,p_NetworkStats);
}
int NET_OP__BR__ETH2 = 88;
void NET_OP__BR__ETH2_ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_OP__BR__ETH2,0);
}
void NET_OP__BR__ETH2_GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_OP__BR__ETH2,p_NetworkStats);
}
int NET_OP__BR__ETH3 = 89;
void NET_OP__BR__ETH3_ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_OP__BR__ETH3,0);
}
void NET_OP__BR__ETH3_GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_OP__BR__ETH3,p_NetworkStats);
}
int NET_OP__BR__ETH4 = 90;
void NET_OP__BR__ETH4_ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_OP__BR__ETH4,0);
}
void NET_OP__BR__ETH4_GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_OP__BR__ETH4,p_NetworkStats);
}
int NET_OP__BR__ETH5 = 91;
void NET_OP__BR__ETH5_ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_OP__BR__ETH5,0);
}
void NET_OP__BR__ETH5_GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_OP__BR__ETH5,p_NetworkStats);
}
int NET_OP__BR__ETH6 = 92;
void NET_OP__BR__ETH6_ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_OP__BR__ETH6,0);
}
void NET_OP__BR__ETH6_GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_OP__BR__ETH6,p_NetworkStats);
}
int NET_OP__BR__ETH7 = 93;
void NET_OP__BR__ETH7_ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_OP__BR__ETH7,0);
}
void NET_OP__BR__ETH7_GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_OP__BR__ETH7,p_NetworkStats);
}
int NET_OP__BR__ETH8 = 94;
void NET_OP__BR__ETH8_ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_OP__BR__ETH8,0);
}
void NET_OP__BR__ETH8_GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_OP__BR__ETH8,p_NetworkStats);
}
int NET_OP__BR__ETH9 = 95;
void NET_OP__BR__ETH9_ClearStats()
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_CLR,NET_OP__BR__ETH9,0);
}
void NET_OP__BR__ETH9_GetStats(NetworkStats * p_NetworkStats)
{
    CM_GetSetValue(g_uiHandle,CM_GETSET_NET_STATS_GET,NET_OP__BR__ETH9,p_NetworkStats);
}
...
void __stdcall CM_ExtensionInit(unsigned int uiHandle, struct stCallBackPointers  * p_stCallBackPointers)
{
    ...
    // network indexes
     ...
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"LIN5 (neoVI 3G)",&NET_LIN5__neoVI_3G_);
     ...
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"Ethernet DAQ (neoVI 3G)",&NET_Ethernet_DAQ__neoVI_3G_);
     ...
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"SW CAN2 (neoVI 3G)",&NET_SW_CAN2__neoVI_3G_);
     ...
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"OP (BR) ETH1",&NET_OP__BR__ETH1);
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"OP (BR) ETH2",&NET_OP__BR__ETH2);
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"OP (BR) ETH3",&NET_OP__BR__ETH3);
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"OP (BR) ETH4",&NET_OP__BR__ETH4);
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"OP (BR) ETH5",&NET_OP__BR__ETH5);
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"OP (BR) ETH6",&NET_OP__BR__ETH6);
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"OP (BR) ETH7",&NET_OP__BR__ETH7);
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"OP (BR) ETH8",&NET_OP__BR__ETH8);
     CM_FindIndexForObjectFromName(g_uiHandle,0,L"OP (BR) ETH9",&NET_OP__BR__ETH9);
    ...
    // database indexes
     ...
     CM_FindIndexForObjectFromName(g_uiHandle,1,L"DB_PLASMA_Time_Resync_neoVI",&DB_PLASMA_Time_Resync_neoVI_Index);
     CM_FindIndexForObjectFromName(g_uiHandle,1,L"DB_PLASMA_Clock_Edge_neoVI",&DB_PLASMA_Clock_Edge_neoVI_Index);
     ...
     CM_FindIndexForObjectFromName(g_uiHandle,1,L"DB_PLASMA_subsystem_restarted__neoVI",&DB_PLASMA_subsystem_restarted__neoVI_Index);
...
void DB_neoVI_Logger_woke_up_neoVI_Init(DB_neoVI_Logger_woke_up_neoVI * pMsg)
{
    ...
    pMsg->WakeUpSms_raw = (uint64)nRawValues[2];
    pMsg->WakeupSlaveA_raw = (uint64)nRawValues[3];
    pMsg->WakeupSlaveB_raw = (uint64)nRawValues[4];
    pMsg->WakeupMainVnet_raw = (BYTE)nRawValues[5];
    pMsg->WakeupUsb_raw = (uint64)nRawValues[6];
    pMsg->PowerBoot_raw = (uint64)nRawValues[7];
    pMsg->LowVbatSleep_raw = (uint64)nRawValues[8];
    pMsg->NoCmSleep_raw = (uint64)nRawValues[9];
    if (g_bUseExtendedIdBit && (pMsg->MessageData.iBitField & ATTR_CAN_29BIT_ID_FRAME))
        pMsg->MessageData.iID = mkExtId(pMsg->MessageData.iID);
}
...
int DB_PLASMA_Time_Resync_neoVI_Index = 21;

void DB_PLASMA_Time_Resync_neoVI_Init(DB_PLASMA_Time_Resync_neoVI * pMsg)
{
    double dValues[1] = {0.0};
    uint64 nRawValues[1] = {0};
    int iActualSignalMaxCount;
    ...
    CM_MessageGenericInit(g_uiHandle, 0, 
    DB_PLASMA_Time_Resync_neoVI_Index, &pMsg->Statistics, &pMsg->MessageData.iNetwork, 
    &pMsg->MessageData.iNumDataBytes, sizeof(pMsg->MessageData.btData),
    &pMsg->iDefaultPeriodMilliseconds, &pMsg->MessageData.iID,
    &pMsg->MessageData.iBitField, &pMsg->MessageData.btData[0],
    &dValues[0], 1, // number of signals when vspy.h was generated
    ...
    memcpy(pMsg->MessageData.btInitialData, pMsg->MessageData.btData, sizeof(pMsg->MessageData.btData));
    pMsg->Timestamp = dValues[0];
    CM_MessageRawInit(g_uiHandle, 0, DB_PLASMA_Time_Resync_neoVI_Index, nRawValues, 1, &iActualSignalMaxCount);
    pMsg->Timestamp_raw = (uint64)nRawValues[0];
    if (g_bUseExtendedIdBit && (pMsg->MessageData.iBitField & ATTR_CAN_29BIT_ID_FRAME))
        pMsg->MessageData.iID = mkExtId(pMsg->MessageData.iID);
}

void DB_PLASMA_Time_Resync_neoVI_LoadSignalValuesArray(DB_PLASMA_Time_Resync_neoVI * pMsg, double *dArray)
{
    dArray[0] = pMsg->Timestamp;
}

void DB_PLASMA_Time_Resync_neoVI_LoadRawSignalValuesArray(DB_PLASMA_Time_Resync_neoVI * pMsg, uint64 *nRawValues)
{
    nRawValues[0] = pMsg->Timestamp_raw;
}

int DB_PLASMA_Time_Resync_neoVI_Transmit(DB_PLASMA_Time_Resync_neoVI * pMsg)
{
    double dArray[1];
    if (memcmp(pMsg->MessageData.btData, pMsg->MessageData.btInitialData, pMsg->MessageData.iNumDataBytes))
    {
        CM_UpdateMessageSignalsFromBytes(g_uiHandle, 0, DB_PLASMA_Time_Resync_neoVI_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
        DB_PLASMA_Time_Resync_neoVI_Init(pMsg);
    }

    DB_PLASMA_Time_Resync_neoVI_LoadSignalValuesArray(pMsg, dArray);

    return CM_TxFromSignals(g_uiHandle, 0, DB_PLASMA_Time_Resync_neoVI_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, dArray, 1);
}

int DB_PLASMA_Time_Resync_neoVI_Transmit_raw(DB_PLASMA_Time_Resync_neoVI * pMsg)
{
    uint64 nRawValues[1];
    if (memcmp(pMsg->MessageData.btData, pMsg->MessageData.btInitialData, sizeof(pMsg->MessageData.btData)))
    {
    ...
    DB_PLASMA_Time_Resync_neoVI_LoadRawSignalValuesArray(pMsg, nRawValues);

    return CM_TxFromRawSignals(g_uiHandle, 0, DB_PLASMA_Time_Resync_neoVI_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, nRawValues, 1);
}

int DB_PLASMA_Time_Resync_neoVI_UpdateBytesFromSignals(DB_PLASMA_Time_Resync_neoVI * pMsg)
{
    double dArray[1];

    DB_PLASMA_Time_Resync_neoVI_LoadSignalValuesArray(pMsg, dArray);

    return CM_UpdateBytesFromSignals(g_uiHandle, 0, DB_PLASMA_Time_Resync_neoVI_Index, dArray, 1, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
}

int DB_PLASMA_Time_Resync_neoVI_UpdateBytesFromRawSignals(DB_PLASMA_Time_Resync_neoVI * pMsg)
{
    uint64 nRawValues[1];

    DB_PLASMA_Time_Resync_neoVI_LoadRawSignalValuesArray(pMsg, nRawValues);

    return CM_UpdateBytesFromRawSignals(g_uiHandle, 0, DB_PLASMA_Time_Resync_neoVI_Index, nRawValues, 1, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
}


int DB_PLASMA_Clock_Edge_neoVI_Index = 22;

void DB_PLASMA_Clock_Edge_neoVI_Init(DB_PLASMA_Clock_Edge_neoVI * pMsg)
{
    int iActualSignalMaxCount;

    CM_MessageGenericInit(g_uiHandle, 0, 
    DB_PLASMA_Clock_Edge_neoVI_Index, &pMsg->Statistics, &pMsg->MessageData.iNetwork, 
    &pMsg->MessageData.iNumDataBytes, sizeof(pMsg->MessageData.btData),
    &pMsg->iDefaultPeriodMilliseconds, &pMsg->MessageData.iID,
    &pMsg->MessageData.iBitField, &pMsg->MessageData.btData[0],
    NULL, 0, // number of signals when vspy.h was generated
...
int DB_PLASMA_Clock_Edge_neoVI_Transmit(DB_PLASMA_Clock_Edge_neoVI * pMsg)
{
    return CM_TxFromSignals(g_uiHandle, 0, DB_PLASMA_Clock_Edge_neoVI_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, 0, 0);
}

int DB_PLASMA_Clock_Edge_neoVI_Transmit_raw(DB_PLASMA_Clock_Edge_neoVI * pMsg)
{
    return CM_TxFromRawSignals(g_uiHandle, 0, DB_PLASMA_Clock_Edge_neoVI_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, 0, 0);
}
...
int DB_PLASMA_subsystem_restarted__neoVI_Index = 26;

void DB_PLASMA_subsystem_restarted__neoVI_Init(DB_PLASMA_subsystem_restarted__neoVI * pMsg)
{
    int iActualSignalMaxCount;

    CM_MessageGenericInit(g_uiHandle, 0, 
    DB_PLASMA_subsystem_restarted__neoVI_Index, &pMsg->Statistics, &pMsg->MessageData.iNetwork, 
    &pMsg->MessageData.iNumDataBytes, sizeof(pMsg->MessageData.btData),
    &pMsg->iDefaultPeriodMilliseconds, &pMsg->MessageData.iID,
    &pMsg->MessageData.iBitField, &pMsg->MessageData.btData[0],
    NULL, 0, // number of signals when vspy.h was generated
...
int DB_PLASMA_subsystem_restarted__neoVI_Transmit(DB_PLASMA_subsystem_restarted__neoVI * pMsg)
{
    return CM_TxFromSignals(g_uiHandle, 0, DB_PLASMA_subsystem_restarted__neoVI_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, 0, 0);
}

int DB_PLASMA_subsystem_restarted__neoVI_Transmit_raw(DB_PLASMA_subsystem_restarted__neoVI * pMsg)
{
    return CM_TxFromRawSignals(g_uiHandle, 0, DB_PLASMA_subsystem_restarted__neoVI_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, 0, 0);
}
...
void DB_Ethernet_DAQ_Report_neoVI_Init(DB_Ethernet_DAQ_Report_neoVI * pMsg)
{
    ...
    pMsg->Recording_raw = (uint64)nRawValues[0];
    pMsg->FPGA_Alive_raw = (uint64)nRawValues[1];
    pMsg->Bad_Chip_raw = (uint64)nRawValues[2];
    pMsg->Raw_MAC_Mode_raw = (uint64)nRawValues[3];
    pMsg->IPv4_Filter_raw = (uint64)nRawValues[4];
    pMsg->RxOverflow_raw = (uint64)nRawValues[5];
    pMsg->CmdBusy_raw = (uint64)nRawValues[6];
    pMsg->LogTO_raw = (uint64)nRawValues[7];
    pMsg->SockActivityTO_raw = (uint64)nRawValues[8];
...
void DB_Scc_Status_neoVI_Init(DB_Scc_Status_neoVI * pMsg)
{
    ...
    pMsg->FvA_raw = (uint64)nRawValues[0];
    pMsg->ScA_raw = (uint64)nRawValues[1];
    pMsg->Atv_raw = (uint64)nRawValues[2];
    pMsg->sip_raw = (uint64)nRawValues[3];
...
void DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_Init(DB_Report_Message__Analog_Card_PWM_Inputs__neoVI * pMsg)
{
    ...
    pMsg->PWM1_IN_raw = (uint64)nRawValues[0];
    pMsg->PWM2_IN_raw = (uint64)nRawValues[1];
    pMsg->PWM3_IN_raw = (uint64)nRawValues[2];
    pMsg->PWM4_IN_raw = (uint64)nRawValues[3];
    pMsg->PWM5_IN_raw = (uint64)nRawValues[4];
    pMsg->PWM6_IN_raw = (uint64)nRawValues[5];
    pMsg->PWM7_IN_raw = (uint64)nRawValues[6];
    pMsg->PWM8_IN_raw = (uint64)nRawValues[7];
    if (g_bUseExtendedIdBit && (pMsg->MessageData.iBitField & ATTR_CAN_29BIT_ID_FRAME))
        pMsg->MessageData.iID = mkExtId(pMsg->MessageData.iID);
}
