...
#define J1939Priority(id)                   ((unsigned long)((id >> 26) & 0x3))
...
#define SetJ1939Priority(id, prio)          (id = (prio << 26) | (id & 0x3FFFFFF))
...
extern int NET_LIN5__neoVI_3G_;
...
extern int NET_Ethernet_DAQ__neoVI_3G_;
...
extern int NET_SW_CAN2__neoVI_3G_;
...
typedef struct {
    ...
    double Temperature; /// Min: -214.677734375 Max: 114.677734375 Units: C
...
typedef struct {
    ...
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
    double Timestamp; /// Min: 0 Max: 1099511627775 Units: ms since 1/1/1970
...
typedef struct {
    ...
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
    double WiviStartSector; /// Min: -2147483647 Max: 2147483647 Units: 
    DWORD WiviStartSector_raw;
    double WiviEndSector; /// Min: -2147483647 Max: 2147483647 Units: 
...
typedef struct {
    ...
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
    double WiviJob; /// Min: -127 Max: 127 Units: 
    BYTE WiviJob_raw;
    double WiviApkResponse; /// Min: -127 Max: 127 Units: 
    BYTE WiviApkResponse_raw;
    double WiviDataTransferMediumChoice; /// Min: -127 Max: 127 Units: 
    BYTE WiviDataTransferMediumChoice_raw;
    double WiviApkResponseTo; /// Min: -127 Max: 127 Units: 
    BYTE WiviApkResponseTo_raw;
    double WiviReserved0; /// Min: -127 Max: 127 Units: 
    BYTE WiviReserved0_raw;
    double WiviReserved1; /// Min: -127 Max: 127 Units: 
...
#define DB_neoVI_Logger_woke_up_neoVI_WakeUpSms_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_neoVI_Logger_woke_up_neoVI_Index, 2, dPhysicalValue);
#define DB_neoVI_Logger_woke_up_neoVI_WakeupSlaveA_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_neoVI_Logger_woke_up_neoVI_Index, 3, dPhysicalValue);
#define DB_neoVI_Logger_woke_up_neoVI_WakeupSlaveB_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_neoVI_Logger_woke_up_neoVI_Index, 4, dPhysicalValue);
...
#define DB_neoVI_Logger_woke_up_neoVI_WakeupUsb_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_neoVI_Logger_woke_up_neoVI_Index, 6, dPhysicalValue);
#define DB_neoVI_Logger_woke_up_neoVI_PowerBoot_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_neoVI_Logger_woke_up_neoVI_Index, 7, dPhysicalValue);
#define DB_neoVI_Logger_woke_up_neoVI_LowVbatSleep_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_neoVI_Logger_woke_up_neoVI_Index, 8, dPhysicalValue);
#define DB_neoVI_Logger_woke_up_neoVI_NoCmSleep_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_neoVI_Logger_woke_up_neoVI_Index, 9, dPhysicalValue);
...
typedef struct {
    ...
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
    double Timestamp; /// Min: 0 Max: 1099511627775 Units: 
    uint64 Timestamp_raw;
...
extern int DB_PLASMA_Time_Resync_neoVI_Index;
typedef struct {
    GenericMessage MessageData; /// Message Data
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
    double Timestamp; /// Min: -53687.091175 Max: 53687.091175 Units: ms
    uint64 Timestamp_raw;
} DB_PLASMA_Time_Resync_neoVI;
...
#define DB_PLASMA_Time_Resync_neoVI_Timestamp_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_PLASMA_Time_Resync_neoVI_Index, 0, dPhysicalValue);
#define DB_PLASMA_Time_Resync_neoVI_ClearStats() \
    CM_GetSetValue(g_uiHandle, CM_GETSET_TX_STATS_CLR, DB_PLASMA_Time_Resync_neoVI_Index, 0)
extern int DB_PLASMA_Clock_Edge_neoVI_Index;
typedef struct {
    GenericMessage MessageData; /// Message Data
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
} DB_PLASMA_Clock_Edge_neoVI;
...
#define DB_PLASMA_Clock_Edge_neoVI_ClearStats() \
    CM_GetSetValue(g_uiHandle, CM_GETSET_TX_STATS_CLR, DB_PLASMA_Clock_Edge_neoVI_Index, 0)
...
extern int DB_PLASMA_subsystem_restarted__neoVI_Index;
typedef struct {
    GenericMessage MessageData; /// Message Data
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
} DB_PLASMA_subsystem_restarted__neoVI;
...
#define DB_PLASMA_subsystem_restarted__neoVI_ClearStats() \
    CM_GetSetValue(g_uiHandle, CM_GETSET_TX_STATS_CLR, DB_PLASMA_subsystem_restarted__neoVI_Index, 0)
...
#define DB_Ethernet_DAQ_Report_neoVI_Recording_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Ethernet_DAQ_Report_neoVI_Index, 0, dPhysicalValue);
#define DB_Ethernet_DAQ_Report_neoVI_FPGA_Alive_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Ethernet_DAQ_Report_neoVI_Index, 1, dPhysicalValue);
#define DB_Ethernet_DAQ_Report_neoVI_Bad_Chip_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Ethernet_DAQ_Report_neoVI_Index, 2, dPhysicalValue);
#define DB_Ethernet_DAQ_Report_neoVI_Raw_MAC_Mode_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Ethernet_DAQ_Report_neoVI_Index, 3, dPhysicalValue);
#define DB_Ethernet_DAQ_Report_neoVI_IPv4_Filter_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Ethernet_DAQ_Report_neoVI_Index, 4, dPhysicalValue);
#define DB_Ethernet_DAQ_Report_neoVI_RxOverflow_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Ethernet_DAQ_Report_neoVI_Index, 5, dPhysicalValue);
#define DB_Ethernet_DAQ_Report_neoVI_CmdBusy_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Ethernet_DAQ_Report_neoVI_Index, 6, dPhysicalValue);
#define DB_Ethernet_DAQ_Report_neoVI_LogTO_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Ethernet_DAQ_Report_neoVI_Index, 7, dPhysicalValue);
#define DB_Ethernet_DAQ_Report_neoVI_SockActivityTO_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Ethernet_DAQ_Report_neoVI_Index, 8, dPhysicalValue);
...
#define DB_Scc_Status_neoVI_FvA_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Scc_Status_neoVI_Index, 0, dPhysicalValue);
#define DB_Scc_Status_neoVI_ScA_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Scc_Status_neoVI_Index, 1, dPhysicalValue);
#define DB_Scc_Status_neoVI_Atv_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Scc_Status_neoVI_Index, 2, dPhysicalValue);
#define DB_Scc_Status_neoVI_sip_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Scc_Status_neoVI_Index, 3, dPhysicalValue);
...
#define DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_PWM1_IN_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_Index, 0, dPhysicalValue);
#define DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_PWM2_IN_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_Index, 1, dPhysicalValue);
#define DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_PWM3_IN_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_Index, 2, dPhysicalValue);
#define DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_PWM4_IN_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_Index, 3, dPhysicalValue);
#define DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_PWM5_IN_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_Index, 4, dPhysicalValue);
#define DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_PWM6_IN_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_Index, 5, dPhysicalValue);
#define DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_PWM7_IN_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_Index, 6, dPhysicalValue);
#define DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_PWM8_IN_PhysicalToRaw(dPhysicalValue) \
    (uint64 )CM_SignalPhysicalToRaw(g_uiHandle, 0, DB_Report_Message__Analog_Card_PWM_Inputs__neoVI_Index, 7, dPhysicalValue);
